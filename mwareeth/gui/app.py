...
class MwareethGUI:
    ...
    def refresh_visualization(self) -> None:
        ...
        try:
            ...
            self.text_view.insert(tk.END, tree.visualize())
    ...
    def update_graphical_view(self, tree) -> None:
        ...
        if graphviz_available:
            try:
                ...
                if deceased:
                    self.builder.generate_family_tree_graphviz(temp_path)
                    ...
                    self.text_view.insert(tk.END, "\n\n")
                    self.text_view.insert(tk.END, _("No deceased person set. Please set a deceased person to visualize the family tree."))
            except Exception as e:
                self.text_view.insert(tk.END, "\n\n")
    ...
    def show_graphviz_not_installed(self):
        ...
        self.text_view.insert(tk.END, _("Graphviz is not installed. Please install it to visualize the family tree graphically."))
        self.text_view.insert(tk.END, "\n\n")
